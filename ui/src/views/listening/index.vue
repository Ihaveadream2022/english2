...
<script>
    /* eslint-disable */
    import { listeningList, listeningAdd, listeningEdit, listeningDelete } from "@/api/request";
    ...
    export default {
        data() {
            return {
                ...
                editDialog: {
                    title: "Create Listening",
                    operation: "add",
                    form: {},
                    visible: false,
                    rules: {
                        title: [{ required: true, message: "Please input listening title", trigger: "blur" }],
                    },
                },
                viewDialog: {
                    title: "View Listening",
                    form: {},
                    visible: false,
                },
            };
        ...
        methods: {
            ...
            editDialogClose() {
                this.$nextTick(() => {
                    ...
                    this.editDialog.title = "Create Listening";
            ...
            editDialogEdit(row) {
                this.editDialog.title = "Edit Listening";
                this.editDialog.visible = true;
                ...
                this.$refs.editDialogForm.validate((valid) => {
                    if (valid) {
                        ...
                        if (this.editDialog.operation == "add") {
                            listeningAdd(this.editDialog.form)
                                .then(
                                    (res) => {
                                        Message({
                                            message: `${res.message}`,
                            ...
                            listeningEdit(this.editDialog.form)
                                .then(
                                    (res) => {
                                        Message({
                                            message: `${res.message}`,
            ...
            editStatus(row, value) {
                ...
                listeningEdit({ ...row, status: value }).then(
                    (res) => {
                        console.log("res", res);
                        loading.close();
                        this.tableGetList(this.table.searchForm);
            ...
            tableGetList(searchForm) {
                listeningList(searchForm.createTime ? { ...searchForm, createTime: `${searchForm.createTime[0]},${searchForm.createTime[1]}` } : { ...searchForm })
                    .then(
                        (res) => {
